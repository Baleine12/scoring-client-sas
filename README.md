...
Ce score correspond à une probabilité estimée de départ du client.
...
2. aperçu des premières observations ;
3. statistiques descriptives ;
4. étude de la répartition de la variable `churn` ;
5. analyse du churn selon le type de contrat ;
6. comparaison des moyennes selon le churn ;
7. estimation d'une régression logistique ;
8. création d'un score de risque ;
9. classement des clients en trois groupes de risque ;
...
- `scoring_client.sas` : script SAS principal ;
- `README.md` : présentation du projet ;
- `Apercu.png` : aperçu des premières lignes de la base ;
- `VariableChurn.png` : répartition de la variable churn ;
- `ChurnSelonContrat.png` : lien entre le churn et le type de contrat ;
- `StatDescriptive.png` : statistiques descriptives.
