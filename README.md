...
L'idée est de reproduire une situation classique en analyse de données : une entreprise souhaite identifier les clients qui risquent de partir afin de mieux comprendre leur profil et éventuellement mettre en place des actions de fidélisation.
...
L'objectif n'est pas seulement de prédire, mais aussi de comprendre les facteurs liés au churn.
